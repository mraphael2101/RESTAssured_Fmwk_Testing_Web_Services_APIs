package com.masteringrestassured.api.tests.get;
...
public class _02_Get_UserId_Associated_Posts_And_Validate_No_Range_Of_The_Returned_PostIds 
{
	@Test
	...
	{   	
		...
		{               
			if ( (obj <= 0) || ( obj > 100) )
				throw new RuntimeException("Post Id " + obj + 
